...
$upload_dir = '/file_server/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../file_server/'; // relative path from filemanager folder to upload folder (with final /)

<form action="<%$PHPSELF%>" method="POST" class="jsonform">
  ...
  <input type="hidden" value="<%$GET.id%>" name="id" />
    <div class="form-group">
        ...
        <input type="text" required="" value="<%$FLEXTEMP.flxedit.t_name|sthsc%>" name="FORM[t_name]" class="form-control" />
    </div>
    <div class="form-group">
        <label>HTML Code:</label>
        <textarea data-theme="<%$gbl_config.ace_theme%>" name="FORM[t_tpl]" class="form-control se-html"><%$FLEXTEMP.flxedit.t_tpl|hsc%></textarea>
    </div>
    <div class="form-group">

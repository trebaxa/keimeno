...
require_once 'Tests/Offline/PhotoSortStrategy/ByColor.php';
require_once 'Tests/Offline/PhotoSortStrategy/ById.php';
require_once 'Tests/Offline/PhotoSortStrategy/ByTakenDate.php';
require_once 'Tests/Offline/PhotoSortStrategy/ByTitle.php';

...
// sub-directories
require_once 'Tests/Offline/Import/AllTests.php';
require_once 'Tests/Offline/PhotoSortStrategy/AllTests.php';
require_once 'Tests/Offline/TextUi/AllTests.php';

// core
require_once 'Tests/Offline/Api.php';
require_once 'Tests/Offline/Cache.php';
require_once 'Tests/Offline/Request.php';
require_once 'Tests/Offline/Response.php';
require_once 'Tests/Offline/Uploader.php';

// wrappers
require_once 'Tests/Offline/AuthedGroup.php';
require_once 'Tests/Offline/AuthedPhoto.php';
require_once 'Tests/Offline/AuthedPhotoset.php';
require_once 'Tests/Offline/AuthedPhotosetList.php';
require_once 'Tests/Offline/AuthedUser.php';
require_once 'Tests/Offline/Group.php';
require_once 'Tests/Offline/GroupList.php';
//require_once 'Tests/Offline/Note.php';
require_once 'Tests/Offline/Photo.php';
require_once 'Tests/Offline/PhotoList.php';
require_once 'Tests/Offline/PhotoListIterator.php';
require_once 'Tests/Offline/Photoset.php';
require_once 'Tests/Offline/PhotosetPhotoList.php';
require_once 'Tests/Offline/PhotosetList.php';
require_once 'Tests/Offline/PhotoSorter.php';
require_once 'Tests/Offline/User.php';
require_once 'Tests/Offline/UserList.php';

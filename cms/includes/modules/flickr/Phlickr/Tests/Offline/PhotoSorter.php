...
require_once 'Tests/constants.inc';

require_once 'PhotoSorter.php';
require_once 'PhotosetPhotoList.php';
require_once 'PhotoSortStrategy/ById.php';
require_once 'PhotoSortStrategy/ByTitle.php';
...
class Phlickr_Tests_Offline_PhotoSorter extends PHPUnit_Framework_TestCase {
    var $api, $psl;

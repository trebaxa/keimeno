<%include file="cb.panel.header.tpl" title="{LBLA_CONFIRMATION} 3/3"%>
<table class="table table-striped table-hover" >
    ...
    <tr><td>{LBLA_CONTENT}:</td><td><iframe style="border:1px solid #eee" src="<% $NEWSLETTER.previewlink %>" width="99%" height="300" name="news_preview" scrolling="yes" marginheight="0" marginwidth="0" frame target="_self" class="thumb"></iframe></td></tr>

...
<div class="infobox">
Konfigurieren Sie hier Ihren Twitter Account, um Beiträge aus dem Portal in Ihrer Twitter Timeline zu veröffentlichen.
...
<div class="infobox">
Sie benötigen einen "Consumer Key" und einen "Secret Key".
...
<br>Mit unserer Twitterschnittstelle können Sie direkt Nachrichten aus dem Portal in Ihren Twitterstream senden.
</div>
<%else%>

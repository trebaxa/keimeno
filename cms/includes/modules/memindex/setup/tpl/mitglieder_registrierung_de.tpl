...
<h2>Login Daten</h2>
    ...
    <div class="form-group">
        ...
        <input type="password" class="required form-control<% if ($kregform_err.passwort!='') %> has-error<% /if %>" id="passwort" placeholder="Passwort" required name="FORM[passwort]" value="<% $kregform.passwort %>" >
    </div> 
...
<div class="row">
    ...
    <div class="col-md-6">  
        ...
        <div class="checkbox">
            <label> 
                <input type="checkbox" required id="agbtrue" name="agbtrue" value="1">Die <a href="{URL_TPL_10045}">AGB</a> habe ich zur Kenntis genommen und mit ihrer Geltung bin ich einverstanden
            </label>    
        </div>
        <div class="checkbox">
            <label>

...
LyteBox.prototype.changeContent = function(imageNum) {
    ...
    if (this.navType == 2 || this.isLyteframe) {
        ...
        object.innerHTML = '<span id="lbPrev2_Off" style="display: none;" class="' + this.theme + '">&laquo; zur&uuml;ck</span><a href="#" id="lbPrev2" class="' + this.theme + '" style="display: none;">&laquo; zur&uuml;ck</a> <b id="lbSpacer" class="' + this.theme + '">||</b> <span id="lbNext2_Off" style="display: none;" class="' + this.theme + '">n&auml;chstes &raquo;</span><a href="#" id="lbNext2" class="' + this.theme + '" style="display: none;">n&auml;chstes &raquo;</a>';

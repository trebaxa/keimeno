...
<div class="btn-group">
    <button class="btn btn-default" type="button" onClick="$('#js-gblvar-editor').html('');simple_load('js-gblvar-table','<%$PATH_CMS%>admin/run.php?epage=gblvars.inc&cmd=ax_load_vars');">Alle anzeigen</button>
</div>

...
<div class="tab-content">
    ...
    <%include file="cb.panel.header.tpl" title="Meine Inhalte" class=""%>
        <div class="btn-group">
            <a class="btn btn-default" href="#" onclick="reload_rsrc_table(0)"><i class="fa fa-table"></i> Meine Inhalte</a>
            <a class="btn btn-default" href="#" data-toggle="modal" data-target="#new-flex-tpl"><i class="fa fa-plus"></i> Neuer Inhalt</a>     
        </div>
    ...
    <div class="modal-content">
      <form action="<%$PHPSELF%>" method="POST" class="jsonform">
          ...
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="new-flex-tplLabel">Neuen Inhalt erstellen</h4>
          </div>

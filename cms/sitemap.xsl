		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<div id="content">
					...
					<p class="info">
						Find more information about XML sitemaps on <a href="http://sitemaps.org">sitemaps.org</a>.
					</p>
					<p class="info">
                    ...
                    <div id="footer"><a target="_blank" title="Keimeno CMS" href="https://www.keimeno.de">Keimeno Sitemap Generator - Keimeno CMS</a></div>
				</div>
			</body>
		</html>
	</xsl:template>

...
function add_show_box_tpl(srclink, title) {
        ...
        $('body').prepend('<div style="position:absolute;overflow:auto!important;" class="modal fade" id="modal_frame" tabindex="-1" role="dialog"><div class="modal-dialog modal-lg" role="dialog"><div class="modal-content"><div class="modal-header"><h5 class="modal-title" id="modal_frameLabel">'+title+'</h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body" id="showboxcontent"></div></div></div></div>');
        $('#modal_frame').modal('show');
